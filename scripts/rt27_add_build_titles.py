...
"领域建模的实施路径：从事件风暴到聚合边界": "A practical path for domain modelling: from event storming to aggregate boundaries",
...
"接口约定测试的适用边界：消费者驱动与提供者验证": "The applicable boundary of contract testing: consumer-driven and provider verification",
