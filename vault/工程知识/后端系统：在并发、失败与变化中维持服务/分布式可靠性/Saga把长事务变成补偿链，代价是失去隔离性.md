...
editorial_note: "清理二分对照1处，改买卖取舍直接陈述，命中1到0，密度0.31达标维持1图"
---
...
这个交换的账要算清楚：**原子性保住了，隔离性丢了**。本地事务逐个提交意味着中间状态对其他请求可见——库存已扣、订单还没建成的窗口里，并发请求看到的是半成品状态。Saga 的定位是"用隔离性换可用性"的明确取舍，把它当作更灵活的事务会误判它的适用场景。
