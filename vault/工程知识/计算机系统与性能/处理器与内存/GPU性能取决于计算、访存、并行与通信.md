...
量化、批处理、算子融合、CUDA Graph 和并行策略改变的资源不同；完整关系见 [[工程知识/AI系统/推理服务与平台/批处理、KV缓存、量化与并行如何改变服务容量]]。

## 关联

- [[工程知识/计算机系统与性能/性能工程：从用户等待到资源瓶颈]]
- [[工程知识/计算机系统与性能/处理器与内存/CPU性能来自有效执行与数据供给]]
- [[工程知识/AI系统/推理服务与平台/推理服务的核心矛盾是延迟、吞吐、显存与质量]]
