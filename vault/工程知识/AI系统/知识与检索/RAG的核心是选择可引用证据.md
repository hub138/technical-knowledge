...
只有当检索、引用、权限、时效和任务结果同时通过，RAG 才能进入线上流量。详细指标见 [[工程知识/AI系统/质量与运营/RAG评测要分离检索质量与生成质量]]。

相关：[[工程知识/AI系统/模型与上下文/记忆是受治理的状态，不是更长的聊天记录]] · [[工程知识/AI系统/质量与运营/Agent评测必须覆盖轨迹而不只看最终答案]]
