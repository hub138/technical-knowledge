...
| **capabilities** | 把 root 权限拆成可单独撤销的能力 | `CAP_SYS_ADMIN` 等高权限能力安全 |
...
关系：[[工程知识/AI系统/安全与治理/沙箱限制能力，策略限制行为]] · [[工程知识/后端与分布式系统/基础设施/Kubernetes管理资源状态，不管理业务正确性]] · [[工程知识/后端与分布式系统/任务与并发/限流熔断与隔离控制故障半径]]
