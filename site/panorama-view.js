...
(function () {
  ...
  function draw(host) {
    ...
    groups.forEach(function (g) {
      var grp = svg("g", { class: "pano-grp", "data-layer": g.layer.id, tabindex: "0", role: "button" });
  ...
  window.TKPanorama = { render: render, isZoomed: function () { return Boolean(zoomed); }, zoomOut: function () { zoomTo(null); } };
})();
