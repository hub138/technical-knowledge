...
(() => {
  ...
  const DICT = {
    ...
    "正在读取…": { en: "Loading…" },
    "追踪 AI 与 Agent 方向的新论文": { en: "New papers in AI and agents, tracked" },
    ...
    "追踪 AI 与 Agent 方向的新论文，逐篇给出结构化解析；知识库的结论从这里取材。": { en: "New papers in AI and agents, each with a structured analysis. The knowledge base draws its evidence from here." },
    "最新论文怎么解析、怎么进知识库": { en: "How new papers are read and fed into the knowledge base" },
    "自己追踪的 AI 与 Agent 论文，逐篇结构化解析，并回流到知识库。": { en: "New articles in AI and agents, tracked and analysed here, then folded into the knowledge base." },
